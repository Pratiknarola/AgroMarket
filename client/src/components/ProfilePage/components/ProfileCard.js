import {AiOutlineUser, FcRating, HiUserCircle, MdEmail, GrStatusGood, GrStatusCritical} from 'react-icons/all'
const ProfileCard = ({user}) => {
    return (
        <div className = 'card_container '>
            <img src = "https://res.cloudinary.com/dk-find-out/image/upload/q_80,w_1920,f_auto/A-Corbis-TL007642_brkxd1.jpg" className = 'imgStyle'/>
            ...
            <h5 
            style = {user.rating > 3.8 ? greenStyle : (user.rating <= 2.0 ? redStyle : yellowStyle)}>
